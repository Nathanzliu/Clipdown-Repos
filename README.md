...
<p align="center">
  ...
  <p align="center">
    一款专为 Gemini 打造的极简、强大的上下文选取、记录与管理的本地收藏库。一键划选，即可秒存代码、Prompt文本与创意灵感。
  </p>
</p>

### 💡 核心痛点

还在不同的话题、文档、标签页和资源库之间，疲于来回复制粘贴吗？还在担心网络代理波动导致会话意外中断，让上下文和对话因网页报错刷新而瞬间蒸发吗？

**Clipdown 重新定义 AI 工作流。** 纯 Local-first 架构。通过局部或全量选取，一键捕获、自动高亮并保留上下文。即使网络不稳定，所划选的内容可即时完整地保存在本地，并完美桥接第三方工作平台，彻底解决会话与内容丢失恐慌，让知识和想法自然流动。
